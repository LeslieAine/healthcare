    ...
    <div className="ba-section">
      ...
      <div className="ba-text-content">
        ...
        <p className="ba-description">
          Discover the reasons to choose Health Plus for your health and homecare needs.
        ...
        <p className="ba-checks ba-check-first">
          <FontAwesomeIcon icon={faCircleCheck} style={{ color: "#1E8FFD" }} /> Best Professional Caregivers
        </p>
