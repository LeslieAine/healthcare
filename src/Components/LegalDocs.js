    ...
    <div className="legal-section-title">
      ...
      <div className="legal-text-content">
        ...
        <p className="legal-description">
          Welcome to Health Plus, your trusted online health and homecare provider. Our
          mission is to provide accessible and personalized care services
          to individuals seeking expert and delicate care from the comfort of their homes. By using
        ...
        <p className="legal-description">
          ...
          includes guidelines for using our platform, interacting with caregivers,
        ...
        <p className="legal-description">
          Our platform connects you with expert caregivers who provide online
          consultations. These consultations are not a replacement for in-person
          visits but serve as a convenient option for care advice,
        ...
        <p className="legal-description">
          Health Plus is designed to simplify homecare access. You can choose
