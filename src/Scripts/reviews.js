export const customerReviews = [
    {
      "name": "Esther Howard",
      "location": "Texas, USA",
      "message": "Health Plus transformed my healthcare experience! The online consultations were so convenient, and the caregivers were knowledgeable and caring."
    },
    {
      "name": "John Doe",
    ...
    },
    {
      ...
      "message": "Booking appointments was a breeze, and the service exceeded my expectations. The caregivers truly listen and provide effective solutions. 5 stars!"
    },
    {
      "name": "Bob Johnson",
    ...
    // },
    {
      "name": "Robert Wilson",
      "location": "Texas, USA",
      "message": "Finally, a health and home care platform that puts patients first! The post-operative care service provided comprehensive care and regular follow-ups. Thank you, Health Plus!"
    },
    {
      "name": "Mary Lee",
      "location": "California, USA",
      "message": "I've been using Health Plus for a variety of my mother's eldery care concerns, and each time, I received exceptional care. It's my go-to for all parents' home care needs!"
    },
    {
      "name": "David Miller",
      "location": "Texas, USA",
